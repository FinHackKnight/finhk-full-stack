...
import { MarketData } from "@/components/market-chart"; // adjust path as needed
...
export interface StockQuote {
  ...
  marketCap?: number;
  timestamp: string;
    chartData?: MarketData[]; // ✅ add chartData
}
...
export function generateMockStocks(count: number = 5): StockQuote[] {
  const mockSymbols = ["AAPL", "MSFT", "GOOGL", "AMZN", "TSLA", "NVDA", "META", "NFLX"];
