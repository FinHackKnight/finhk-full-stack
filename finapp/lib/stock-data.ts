...
const mockNewsData: StockNewsItem[] = [
  {
    ...
    description:
      "Apple Inc. reported better-than-expected earnings for the fourth quarter, driven by strong iPhone sales.",
  ...
  },
  {
    ...
    description:
      "Microsoft Corporation reported slower growth in its Azure cloud computing division.",
  ...
  },
  {
    ...
    description:
      "Alphabet Inc. sees significant returns from its artificial intelligence investments.",
  ...
  },
  {
    ...
    description:
      "Tesla faces production delays at its new manufacturing facility.",
  ...
  },
  {
    ...
    description:
      "NVIDIA reports record demand for its AI and data center chips, driving strong revenue growth.",
  ...
  },
  {
    ...
    description:
      "NVIDIA announces new partnerships with major cloud providers to expand AI infrastructure.",
  ...
  },
  {
    ...
    description:
      "NVIDIA reports strong gaming segment performance with new RTX series adoption.",
...
export async function getMultipleStockQuotes(
  ...
  console.warn(
    `getMultipleStockQuotes called for ${symbols.join(", ")} - using mock data`
  );
...
export async function getStockNews(
  ...
  // TODO: Implement actual API call
  console.warn(
    `getStockNews called for ${
      symbols ? symbols.join(", ") : "general"
    } - using mock data`
  );
  ...
  for (let i = 0; i < Math.min(limit, 10); i++) {
    articles.push({
      title: `${
        symbols && symbols.length > 0 ? symbols[0] : "Market"
      } Stock Analysis ${i + 1}`,
      description:
        "Mock news article about the stock market and financial trends",
      url: "#",
